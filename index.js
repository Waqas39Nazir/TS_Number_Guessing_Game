...
const displayStats = () => {
    console.clear();
    console.log(gradient.pastel.multiline(`Lifes:${lifes}   ........... <= RANDOM NUBMER GUESSING GAME => ...........   Score:${score}\n`));
};
...
const scoreAndLifeHandler = (number) => {
        ...
        .prompt([
        {
            ...
            validate: (value) => {
                if (value > 9 || value < 0 || isNaN(value)) {
                    console.log("\n", gradient.pastel.multiline("Error::Only numbers between 0 and 9 are allowed"));
                    return false;
                }
                return true;
            },
